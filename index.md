...
<div class="container">
    <div class="row-fluid">
        <div class="span7">
            ...
            <br>
            My research interests include semiparametric regression, longitudinal data analysis, replicability, and computationally efficient resampling methods. I am also interested in applications in a variety of fields, including psychology, medicine, sociology, life sciences, and the environment. You can find more information on my <a href = "{{ BASE_PATH }}/pages/research.html">research page</a> or by <a href = "{{ BASE_PATH }}/assets/bdsegal_cv.pdf"> downloading my CV</a>.
        </div>
