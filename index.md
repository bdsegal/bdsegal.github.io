...
<div class="container">
    <div class="row-fluid">
        <div class="span7">
            ...
            <br>
            My research interests include computationally efficient resampling methods, nonparametric and semiparametric regression, longitudinal analysis, and estimation-based alternatives to hypothesis testing. I am also interested in applications in a variety of fields, including medicine, the life sciences, sociology, psychology, and the environment. You can find more information on my <a href = "{{ BASE_PATH }}/pages/research.html">research page</a> or by <a href = "{{ BASE_PATH }}/assets/bdsegal_cv.pdf"> downloading my CV</a>.
        </div>
